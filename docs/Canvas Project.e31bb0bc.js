...
var Paddle = /*#__PURE__*/function () {
  ...
  _createClass(Paddle, [{
    ...
    key: "keepWithinCanvas",
    value: function keepWithinCanvas() {
      if (this.position.x < this.boundary.minX) this.position.x = this.boundary.minX;
      if (this.position.x > this.boundary.maxX) this.position.x = this.boundary.maxX;
    }
  }, {
    key: "update",
...
},{}],"JS/CollisionDetection.js":[function(require,module,exports) {
"use strict";
...
function detectCollision(ball, gameObject) {
  ...
  return bottomOfBall >= topOfObject && topOfBall <= bottomOfObject && ball.position.x >= leftOfObject && ball.position.x + ball.size <= rightOfObject;
}
},{}],"JS/Brick.js":[function(require,module,exports) {
"use strict";
...
},{"./CollisionDetection":"JS/CollisionDetection.js"}],"JS/Ball.js":[function(require,module,exports) {
"use strict";
...
var Ball = /*#__PURE__*/function () {
  ...
  _createClass(Ball, [{
    ...
    value: function detectWallCollision() {
      if (this.position.x < this.gameBoundary.minX || this.position.x > this.gameBoundary.maxX) {
      ...
      if (this.position.y < this.gameBoundary.minY || this.position.y > this.gameBoundary.maxY) {
    ...
    value: function update(dt) {
      ...
      this.position.y += this.speed.y; // this.keepWithinCanvas();

      this.detectWallCollision();

      if ((0, _CollisionDetection.detectCollision)(this, this.paddle)) {
        this.reverseBallYSpeed();
        this.position.y = this.paddle.position.y - this.size;
      }
    }
  }, {
    key: "reverseBallYSpeed",
    value: function reverseBallYSpeed() {
      this.speed.y = -this.speed.y;
    }
  }]);
...
},{"./CollisionDetection":"JS/CollisionDetection.js"}],"JS/InputHandler.js":[function(require,module,exports) {
"use strict";
...
},{"./Paddle.js":"JS/Paddle.js","./Brick.js":"JS/Brick.js","./Ball.js":"JS/Ball.js","./InputHandler.js":"JS/InputHandler.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
function gameLoop(timestamp) {
  ...
  lastTime = timestamp; //Clear Canvas
...
requestAnimationFrame(gameLoop);
},{"./JS/Game.js":"JS/Game.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/Canvas%20Project.e31bb0bc.js.map